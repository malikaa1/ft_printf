...
#define INIT_PARSER(P) format_parser P = { .errors_count = 0, .flag = ' ', .precision = -1, .specifier = ' ', .width = -1, .is_dynamic_precision = 0, .is_dynamic_wdith = 0};
...
void output_pointer_flag(long long int ptr, int width, int lenght, char flag);
